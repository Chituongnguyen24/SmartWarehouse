...
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)(user_entity_1.UserRole.ADMIN, user_entity_1.UserRole.WAREHOUSE_MANAGER),
    ...
    (0, swagger_1.ApiBody)({
        schema: {
            ...
            properties: {
                ...
                role: { type: 'string', enum: Object.values(user_entity_1.UserRole), example: 'WAREHOUSE_STAFF' },
            },
